...
import 'package:flutter_getting_start/styles/styles.dart';
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Image.network("https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=1946244045,749707381&fm=26&gp=0.jpg", scale: 3,)
          ],
        ),
      ),
